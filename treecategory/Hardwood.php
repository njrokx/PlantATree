...
<div class="container">
    ...
    <img src="../images/HardwoodGeneric.jpg" alt="Hardwood"style="width:300px;height:400px;" >
    <div class="tree-list-name"><?php echo "HardWood Maple"; ?></div>
    ...
    <div class="tree-list-size">Size: <?php echo "5m - 15m"; ?></div>
