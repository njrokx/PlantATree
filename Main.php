                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="ecommerce-buttons-wrapper">
                            <a class="login-link" href="/login.php">Sign In<span class="icon-SignIn"></span></a>
                            <div id="Shoppingcart_cart" class="Shoppingcart_cart" style="margin: 0px;">
                                <div class="items"><a class="view-cart-link">View Cart<span class="icon-Barrow"></span></a> (0)</div>
